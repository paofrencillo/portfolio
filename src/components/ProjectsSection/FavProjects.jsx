...
export default function FavProjects() {
  ...
  return (
    <>
      <div className="flex flex-wrap gap-6 mb-16" data-aos="fade-up">
        {favs.map((fav) => {
          return (
            <div
              key={fav.id}
              className="group relative shadow-2xl bg-gray-100 shadow-sky-900 w-[300px] rounded-md p-5 pb-20"
            >
              ...
              <div className="rounded-b-md absolute bottom-0 left-0 w-full flex justify-around h-14 bg-yellow-100 text-3xl text-yellow-500 font-bold">
                <div className="transition delay-150 duration-300 ease-in-out rounded-bl-md grid place-content-center hover:bg-yellow-500 w-full h-full hover:text-gray-200 cursor-pointer">
                  <HiExternalLink />
                </div>
                <div className="transition delay-150 duration-300 ease-in-out rounded-br-md grid place-content-center hover:bg-yellow-500 w-full h-full hover:text-gray-200 cursor-pointer">
                  <FiGithub />
                </div>
              </div>
            </div>
